...
namespace Blog.BLL
{
	...
	{
		private readonly Blog.DAL.BlogPhotoAlblumDAL dal=new Blog.DAL.BlogPhotoAlblumDAL();
		...
		/// 获得数据列表
		/// </summary>
		public List<Blog.Model.BlogPhotoAlblum> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Blog.Model.BlogPhotoAlblum> DataTableToList(DataTable dt)
		{
			List<Blog.Model.BlogPhotoAlblum> modelList = new List<Blog.Model.BlogPhotoAlblum>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Blog.Model.BlogPhotoAlblum model;
